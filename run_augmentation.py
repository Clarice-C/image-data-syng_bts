...
# Variance filter (Python implementation; groups* columns are skipped automatically)
...
skip_columns = None          # optional extra skip list, e.g. ["patient_id"]
skip_prefixes = DEFAULT_SKIP_PREFIXES  # shared skip prefixes (groups, groups2, ...)
...
ApplyExperiment(
    ...
    model="CVAE1-1",                # Model type: Conditional MAF (Normalizing Flow) - supports groups + groups2
                                # Alternative options: "realnvp", "glow"
                                # Note: Conditional Flow models are recommended for this data type
    batch_frac=0.1,
